 ...
 */
$conf['settings']['app.title'] = 'Sampel hotel Ltd';			// application title
...
$conf['settings']['admin.email'] = 'admin@litemediaweb.com.ng';         // email address of admin user
...
$conf['settings']['script.url'] = 'https://www.litemediaweb.com.ng/booked/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['database']['user'] = 'litemed1_phps916';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'v7S]p!6.pD)p!d69';
$conf['settings']['database']['hostspec'] = 'localhost';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'litemed1_phps916';
/**
 ...
 */
$conf['settings']['install.password'] = 'ywgsvhin';
/**
 * Pages
 */
